...
#define wheel_dia: 0.0371,
#define wheel_dist: 0.395,
    ...
    BaseController()
      {
        ...
        n.param<std::string>("serialport/name", serialport, "/dev/ttyUSB0");                      // Get serialportname from ROS Parameter sevice, default is ttyS0 (pcDuinos GPIO UART)
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    void cmd_vel_callback(const geometry_msgs::Twist& vel_cmd){
        ...
        requested_speed_l = 128 + (2*vel_cmd.linear.x+vel_cmd.angular.z*wheel_dist)/(wheel_dia);
        requested_speed_r = 128 + (2*vel_cmd.linear.x-vel_cmd.angular.z*wheel_dist)/(wheel_dia);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    void get_encoders(void){
        ...
        {
        uint8_t * Incoderptr = (uint8_t *)&incoder1  ;
        for(int i = 0 ; i<4 ; i++ ){Incoderptr [3-i] =Serial2.read();}
    
        Incoderptr =  (uint8_t *)&incoder2 ;
        for(int i = 0 ; i<4 ; i++){Incoderptr [3-i] =Serial2.read();}
        }*/
